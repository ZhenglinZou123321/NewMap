...
for vehicle_id in traci.simulation.getArrivedIDList():
    ...
    #depart_time = traci.vehicle.getDepartTime(vehicle_id)
    #arrival_time = traci.vehicle.getArrivalTime(vehicle_id)
    #time_used = arrival_time - depart_time
...
try:
    ...
    trained_data[str(trained_data['times'])] = total_time
